...
/*    object Image : NavRoute("images/", null, "Images")*/
    object Musics : NavRoute("musics/", R.drawable.music_48, "Musics")
    object Music : NavRoute("musics/", null, "Musics")
    object Video : NavRoute("videos/", R.drawable.video_48, "Videos")
